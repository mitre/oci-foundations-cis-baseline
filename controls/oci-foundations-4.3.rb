control 'oci-foundations-4.3' do
  ...
  regions.each do |region|
    ...
    findings << <<~ENTRY.chomp unless rule_present
      Region: #{region}
      Issue: Missing enabled Identity Provider change notification rule(s)
    ENTRY
  end
  ...
  describe 'Identity Provider change notifications' do
