control 'oci-foundations-4.9' do
  ...
  regions.each do |region|
    ...
    findings << <<~ENTRY.chomp unless rule_present
      Region: #{region}
      Issue: Missing enabled route table change notification rule(s)
    ENTRY
  end
  ...
  describe 'Route table change notifications' do
