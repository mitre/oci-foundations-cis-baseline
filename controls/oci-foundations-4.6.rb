control 'oci-foundations-4.6' do
  ...
  regions.each do |region|
    ...
    findings << { region: region, issue: 'Missing enabled IAM policy change notification rule(s)' } unless rule_present
  end
